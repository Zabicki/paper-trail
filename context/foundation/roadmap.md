...
| D      | Daily-use polish     | `S-07` → `S-09` → `S-10` · `S-08`, `S-11` parallel | Post-MVP pass over shipped surfaces, driven by real use rather than by the PRD. Joins Stream A at `S-03`, Stream B at `S-05`, Stream C at `S-06`. `S-11` is the first slice driven by testing on an actual phone rather than a narrow browser window. |
