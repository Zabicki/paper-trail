...
- `npm run test:e2e` / `npm run test:e2e:ui` — Playwright. Needs a free port 4321 and a running local Supabase stack; it drives the real app, nothing is mocked. See `tests/e2e/README.md`.
